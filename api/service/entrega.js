...
Entrega.methods(['get', 'post', 'put', 'delete'])

//sempre que dar update retornará o objeto novo e não o objeto antigo / e fazer validações também ao fazer update
Entrega.updateOptions( { new: true, runValidators: true } )
Entrega.after('post', sendErrorsOrNext).after('put', sendErrorsOrNext)
...
Entrega.route('count', function(req, res, next) {
  ...
  Entrega.count(function(error, value) {
    if(error) {
